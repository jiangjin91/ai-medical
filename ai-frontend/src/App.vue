...
// 当前 customer-service-backend 只提供 /api/chat 和 /api/chat/history，
// 没有提供数字人会话与 WebSocket 接口。默认关闭，避免页面加载时请求
// 不存在的 /api/avatar/session 并显示错误；后端接入这些接口后，可在
// .env.local 中设置 VITE_ENABLE_AVATAR=true 再启用。
  ...
  <div class="app-shell">
    ...
    <div class="workspace">
      <div class="chat-card">
        ...
        <section v-if="ENABLE_AVATAR" class="avatar-stage">
