...
from atguigu.domain.messages import UserMessage, MessageType, FocusedObject, BotMessage, ChatHistoryMessage
...
class ChatHistoryBuilder:
    ...
    @classmethod
    def _render_text_message(cls, text):
        return text.strip()
    ...
    @staticmethod
    def build_chat_history(session_id: str,role: Literal["user", "bot"], text: str | None = None, object: FocusedObject | None = None) -> ChatHistoryMessage:
